...
export const parkChungHee: President = {
  ...
  policies: [
    {
      ...
      glossary: [
        {
          term: "경제개발 5개년 계획",
          description: "국가 주도로 목표 경제성장률을 설정하고 전략 산업을 집중 육성하는 중장기 경제 정책입니다."
        }
      ],
      chart: {
        title: "수출액 증가 추이 (억 달러)",
        domesticLabel: "대한민국 수출액",
        source: "한국무역협회 / World Bank",
        data: [
          { name: "1962", domestic: 0.5 },
          { name: "1966", domestic: 2.5 },
          { name: "1970", domestic: 8.3 },
          { name: "1974", domestic: 44.6 },
          { name: "1979", domestic: 150.5 }
        ]
      },
  ...
  legacies: [
    ...
    },
    {
      ...
      description: "1977년 시범 실시된 의료보험은 현재 전국민 의료제도의 직접적 출발점. 현재 건강보험공단이 운영하는 전국민 건강보험의 제도적 기두.",
      source: "건강보험공단"
    }
  ],
